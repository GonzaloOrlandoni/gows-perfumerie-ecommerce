...
const ItemDetail = () => {
  ...
  useEffect(() => {
    ...
    return () => {
      document.title = "GOWS Perfumerie | Fragancias de Alta Gama";
    };
  }, [itemId]);
  ...
  const handleAdd = () => {
    addItem(
      { ...product, precio: currentPrice, selectedSize: selectedSize?.ml },
      quantity,
    );
    setAdded(true);
    addToast(
      `${product.nombre} ${selectedSize ? `(${selectedSize.ml}ml)` : ""} agregado al carrito 🛍️`,
      "success",
    );
  ...
  if (error || !product) {
    return (
      <div className="min-h-[60vh] flex flex-col items-center justify-center text-center px-4">
        ...
        <Link
          to="/"
          className="bg-black text-white px-8 py-3 text-xs tracking-widest uppercase"
        >
          Volver a la tienda
        </Link>
      </div>
      ...
      <div className="grid md:grid-cols-2 gap-12 lg:gap-20">
        ...
        <div className="relative">
          ...
          <button
            ...
            aria-label={
              inWishlist ? "Quitar de favoritos" : "Guardar en favoritos"
            }
        ...
        <div className="flex flex-col justify-center">
          ...
          {product.notas && (
            <div className="border-t border-gray-100 pt-5 mb-8">
              ...
              <p
                className="text-sm text-gray-700 font-light italic"
                style={{ fontFamily: "var(--font-serif)" }}
              >
                {product.notas}
              </p>
